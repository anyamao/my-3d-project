...
import { Search, Sun, Wind, CloudRain, Droplet, Settings } from "lucide-react";
...
const AnimationControls: React.FC<AnimationControlsProps> = ({
  ...
  return (
    <div className="relative top-0 mt-[-30px]  ml-[20px] flex  z-10 ">
      <a
        className="text-[16px] fixed  text-white z-30 top-0 right-0 mt-[20px] mr-[50px] cursor-pointer hover:underline"
        href="https://t.me/anyamaoo"
      >
        anyamao's weather app
      </a>
      <Settings className="text-lime-600 w-[25px] h-[25px] fixed top-0 right-0 mt-[20px] hover:scale-125 transition-translate duration-300 transition-all hover:rotate-45 cursor-pointer mr-[10px]"></Settings>
      ...
      <div className=" fixed top-0 mt-[155px]  ml-[95px] w-[280px] flex  flex-col z-20 ">
        <div className="w-full h-[40px] flex  items-center shadow-md rounded-full p-[10px] mt-[5px]">
          ...
          <input
            ...
            className="outline-none bg-transparent text-[15px] text-gray-600"
          ></input>
        </div>
        <div className="w-full flex  mt-[15px] justify-between border-b-[1px] border-b-gray-300  p-[10px] pb-[20px]">
          <div className="flex flex-col">
            ...
            <div className="text-gray-500 text-[16px]">Sunny</div>
          </div>
